...
| --------------------------- | -------------------------------------- | --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| monkeys                     | infmonkeys/monkeys                     | https://hub.docker.com/r/infmonkeys/monkeys                     | https://static.infmonkeys.com/docker/monkeys/monkeys/monkeys-0.0.28.zip                                         |
| monkeys-ui                  | infmonkeys/monkeys-ui                  | https://hub.docker.com/r/infmonkeys/monkeys-ui                  | https://static.infmonkeys.com/docker/monkeys/monkeys-ui/monkeys-ui-0.0.28.zip                                   |
